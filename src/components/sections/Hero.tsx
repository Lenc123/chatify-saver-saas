      ...
      <div className="turso-container relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className="mb-6">
              <div className="inline-block px-3 py-1 bg-[#008080]/10 text-[#008080] rounded-full mb-4 font-medium text-sm mt-6 sm:mt-0">
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-gray-900 mb-4">
                ...
                <span className="text-[#008080] block mt-2 lg:text-4xl">No more tickets, just happy customers.</span>
              </h1>
            ...
            <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row gap-4">
              <Button className="bg-[#008080] hover:bg-[#008080]/90 text-white rounded-md shadow-lg hover:shadow-xl transition-shadow">
              ...
              <div className="p-3 border-t border-gray-100 bg-gray-50">
                <div className="flex items-center">
                  <input
                    ...
                    className="flex-1 py-2 px-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#008080]/50 mr-2"
                    onKeyPress={(e) => e.key === 'Enter' && handleSendMessage()}
                  />
                  <Button 
                    className="bg-[#008080] hover:bg-[#008080]/90 text-white rounded-full"
                    size="icon" 
