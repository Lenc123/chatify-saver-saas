  ...
  return (
    <div className={`flex ${isLast ? '' : 'mb-12 sm:mb-0'}`}>
      ...
      <div className="hidden sm:flex flex-col items-center mr-8">
        <div className="flex items-center justify-center w-10 h-10 rounded-full bg-[#008080]/20 text-[#008080] font-bold">
          {step}
        </div>
      ...
      {/* Mobile Circle */}
      <div className="flex sm:hidden items-center justify-center w-10 h-10 rounded-full bg-[#008080]/20 text-[#008080] font-bold mr-4 flex-shrink-0">
        {step}
      </div>
  ...
  return (
    <section className="py-16 sm:py-20 relative overflow-hidden bg-white">
      ...
      <div className="absolute top-0 left-0 w-full h-full">
        <div className="absolute top-20 right-20 w-60 h-60 bg-[#008080]/5 rounded-full blur-3xl"></div>
        <div className="absolute bottom-40 left-20 w-40 h-40 bg-[#008080]/10 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="turso-container">
        <AnimatedCard className="text-center max-w-3xl mx-auto mb-10 sm:mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 text-gray-900">Get Started in <span className="text-[#008080]">Minutes</span>, Not Weeks</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12">
          <div className="md:col-span-5">
            <AnimatedCard className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 sm:p-8 h-full">
              <h3 className="text-2xl font-bold mb-4 text-gray-900">Ready for <span className="text-[#008080]">Better Support?</span></h3>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-[#008080] mr-2 flex-shrink-0 mt-0.5" />
              ...
              <div className="mt-8 bg-gray-50 rounded-lg p-4 border border-gray-100">
                ...
                <div className="text-2xl font-bold text-[#008080]">Just 24 Minutes</div>
