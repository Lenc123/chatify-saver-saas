  ...
  return (
    <section className="turso-section bg-[#F2FCE2]">
      <div className="turso-container">
        ...
        <div className="flex justify-between mb-8 bg-white rounded-lg p-2 shadow-sm">
          {timelineSteps.map((step, index) => (
            <button
              key={index}
              className={`px-6 py-3 rounded-lg transition-all duration-200 flex items-center justify-center cursor-pointer ${
                activeStep === index 
                ? 'bg-[#E5DEFF] shadow-sm font-medium text-brand-secondary' 
                : 'bg-transparent hover:bg-[#F1F0FB]/70'
              }`}
        ...
        <div className="relative h-2 bg-white rounded-full mb-12 overflow-hidden shadow-inner">
